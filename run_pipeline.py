...
def main():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            subprocess.Popen([sys.executable, "src/api.py"], 
    ...
    test_commands = [
        ...
        ('curl -s -X POST http://localhost:5000/predict -H "Content-Type: application/json" -d \'{"MedInc": 8.3252, "HouseAge": 41.0, "AveRooms": 6.98, "AveBedrms": 1.02, "Population": 322.0, "AveOccup": 2.55, "Latitude": 37.88, "Longitude": -122.23}\'', "Prediction test")
    ]
