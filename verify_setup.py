...
def main():
    ...
    data_files = ["X_train.csv", "X_test.csv", "y_train.csv", "y_test.csv", "scaler.pkl"]
    total_checks += 1
    ...
    modules_to_check = [
        "pandas", "numpy", "sklearn", "flask", "mlflow", "joblib"
    ]
    ...
    if checks_passed == total_checks:
        ...
        print(f"{total_checks - checks_passed} checks failed. Please review the issues above.")
        print("\nCommon fixes:")
